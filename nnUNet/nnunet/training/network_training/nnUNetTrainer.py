...
class nnUNetTrainer(NetworkTrainer):
    ...
    def run_AMAT_training(self, counter):
        self.save_debug_information()
        super(nnUNetTrainer, self).run_AMAT_training(counter)
        
    def run_AMAT_training_grid(self, counter, params):
        self.save_debug_information()
        super(nnUNetTrainer, self).run_AMAT_training_grid(counter, params)
