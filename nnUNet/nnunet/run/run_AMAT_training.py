...
def main(params):
    ...
    parser.add_argument("--disable_postprocessing_on_folds", required=False, action='store_true',
                        help="Running postprocessing on each fold only makes sense when developing with nnU-Net and "
                             ...
                             "reported issues with very large AMATges. If your AMATges are large (>600x600x600 voxels) "
    ...
    if find_lr:
        ...
        if not validation_only:
            ...
            trainer.run_AMAT_training_grid(params)
        else:
            if valbest:
...
if __name__ == "__main__":
    ...
    # delta is the hyperparameter. this program is for grid search use
    if choice == 0:
        # D2
