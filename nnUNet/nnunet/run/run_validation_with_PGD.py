...
if __name__ == "__main__":
    ...
    # noise name
    noiseDict =[[5,10,15],#D2
                [2,6,10],#D4 
                [10,20,40],#D5
                [0,10,50,90]]#D9 
    noises = noiseDict[choice]
    #methods names
    #["AMAT15","PGD15","PGD5","PGD1","nnUnet"],#D4
    ...
    basePath = base+"/amat_conference/amat_conf/nnUNet/resultFolder/nnUNet/2d/"+selected+"/nnUNetTrainerV2__nnUNetPlansv2.1"
